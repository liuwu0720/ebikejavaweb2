   ...
   <div class="maindiv">
   		<form id="dgform" class="easyui-form" enctype="multipart/form-data"
			...
			<tr>
				<th>已受理资料：</th>
				<td colspan="3">
					<c:forEach items="${selectSlzls }" var="gd">
						${gd.dmms1 }<br/>
					</c:forEach>
				</td>
				<th>归档意见：</th>
			...
			<tr>
				<th>驾驶人1照片</th>
				<td><input  type="file" id="headimg_jsr1" name="headimg_jsr1" onchange="CheckFileSize(this);" disabled="disabled" /></td>
				<th>驾驶人2照片</th>
				<td><input  type="file"  id="headimg_jsr2" name="headimg_jsr2" onchange="CheckFileSize(this);" disabled="disabled" /></td>
				<th>车身照片</th>
				<td  colspan="3"><input  id="ebike_img" type="file" name="ebike_img" onchange="CheckFileSize(this);"  disabled="disabled"/></td>
			</tr>
				<tr>
					<td colspan="2">
					<div class="imgdiv"> 
				...
				<tr>
				<th>驾驶人1身份证正面</th>
				<td><input  type="file" id="card1img_jsr1" name="card1img_jsr1" onchange="CheckFileSize(this);" disabled="disabled" /></td>
				<th>驾驶人1身份证反面</th>
				<td><input  type="file"  id="card2img_jsr1" name="card2img_jsr1" onchange="CheckFileSize(this);" disabled="disabled" /></td>
				<th>驾驶人2身份证正面</th>
				<td><input  id="card1img_jsr2" type="file" name="card1img_jsr2" onchange="CheckFileSize(this);"  disabled="disabled"/></td>
				<th>驾驶人2身份证反面</th>
				<td><input  id="card2img_jsr2" type="file" name="card2img_jsr2" onchange="CheckFileSize(this);"  disabled="disabled"/></td>
			...
			<input type="hidden" value="${ddcDaxxb.vcUser1CardImg1 }" name="vcUser1CardImg1">
			<input type="hidden" value="${ddcDaxxb.vcUser1CardImg2 }" name="vcUser1CardImg2">
			<input type="hidden" value="${ddcDaxxb.vcUser2CardImg1 }" name="vcUser2CardImg1">
			<input type="hidden" value="${ddcDaxxb.vcUser2CardImg2 }" name="vcUser2CardImg2">
		</form>
