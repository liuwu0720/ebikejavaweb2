...
import com.node.obj.TrafficData;
 ...
 * @version: 1.0
 * @author: liuwu
 * @version: 2016年8月8日 下午4:48:22 
 */
public class TrafficMsgQueryUtil {
	...
	public  List<TrafficMsg> postHttp(String cphm) {
		...
		try {
			cphm = new String(cphm.getBytes("ISO-8859-1"), "utf-8");
			partnerUserId = new String(partnerUserId.getBytes("ISO-8859-1"), "utf-8");
		} catch (UnsupportedEncodingException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		trafficData.setLicensePlateNo(cphm);
		trafficData.setLicensePlateType("07");
		String msg = JSONObject.fromObject(trafficData).toString();
